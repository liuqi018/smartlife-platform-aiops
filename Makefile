...
help:
	@echo "$(GREEN)═══════════════════════════════════════════════════════$(NC)"
	@echo "$(GREEN)  SmartLife AIOps - Makefile 命令$(NC)"
	@echo "$(GREEN)═══════════════════════════════════════════════════════$(NC)"
	@echo ""
	@echo "$(CYAN)【一键操作】$(NC)"
	...
	@echo "  $(YELLOW)make up$(NC)           - 🐳 启动 AIOps 基础设施（Redis + Milvus）"
	@echo "  $(YELLOW)make down$(NC)         - 🛑 停止 AIOps 基础设施"
...
init:
	@echo "$(GREEN)═══════════════════════════════════════════════════════$(NC)"
	@echo "$(GREEN)🚀 开始一键初始化 SmartLife AIOps...$(NC)"
	@echo "$(GREEN)═══════════════════════════════════════════════════════$(NC)"
	@echo ""
	@echo "$(YELLOW)步骤 1/4: 启动 AIOps 基础设施（Redis + Milvus）$(NC)"
	@$(MAKE) up
	@echo ""
...
# ============================================================
# AIOps 基础设施管理（不管理业务 Prometheus/Alertmanager）
# ============================================================

# 启动 Redis、Milvus、etcd、MinIO 和 Attu
up:
	...
	@if docker ps --format '{{.Names}}' | grep -q "^$(MILVUS_CONTAINER)$$"; then \
		...
		echo "$(YELLOW)🚀 启动 AIOps 基础设施容器...$(NC)"; \
...
# 停止 AIOps 基础设施容器
down:
	@echo "$(YELLOW)🛑 停止 AIOps 基础设施容器...$(NC)"
